...
internal interface JavacProcessingEnv : XProcessingEnv {
    ...
    fun wrapTypeElement(element: TypeElement): JavacTypeElement
    ...
    fun wrapAnnotatedElement(element: Element, annotationName: String): XElement

    fun <T : JavacType> wrap(
