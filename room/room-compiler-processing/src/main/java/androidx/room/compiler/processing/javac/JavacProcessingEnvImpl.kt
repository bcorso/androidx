...
internal class JavacProcessingEnvImpl(
    override val delegate: ProcessingEnvironment
) : JavacProcessingEnv {
    override val backend: XProcessingEnv.Backend = XProcessingEnv.Backend.JAVAC

    override val elementUtils: Elements = delegate.elementUtils

    override val typeUtils: Types = delegate.typeUtils
    ...
    override fun wrapTypeElement(element: TypeElement) = typeElementStore[element]
    ...
    override fun wrapAnnotatedElement(
        element: Element,
    ...
    override fun wrapExecutableElement(element: ExecutableElement): JavacExecutableElement {
    ...
    override fun wrapVariableElement(element: VariableElement): JavacVariableElement {
